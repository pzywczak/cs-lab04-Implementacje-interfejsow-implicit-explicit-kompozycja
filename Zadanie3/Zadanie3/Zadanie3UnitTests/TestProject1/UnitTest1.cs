...
namespace Zadanie3UnitTests
{
    ...
    public class UnitTestMultifunctionalDevice
    {
        ...
        {
            var device = new MultifunctionalDevice("2312412");
            device.PowerOn();

            IDocument doc1 = new PDFDocument("aaa.pdf");
            string faxNumber = "12345";
            device.Fax(doc1, faxNumber);
            IDocument doc2 = new ImageDocument("p.jpg");
            device.Fax(doc2, "09876");
            IDocument doc3 = new TextDocument("aaa.txt");
            device.Fax(doc3, "45678899");
            device.PowerOff();

            // 3 faxy kiedy urz¹dzenie jest w³¹czone
            Assert.AreEqual(3, device.FaxNumber);
        }
        [TestMethod]
        public void MultifunctionalDevice_SendFax_DeviceOn()
        {
            var device = new MultifunctionalDevice("231232132");
            device.PowerOn();
        ...
        {
            var device = new MultifunctionalDevice("42421412");
            device.PowerOff();
        ...
        {
            var device = new MultifunctionalDevice("32321241");
            device.PowerOn();
        ...
        {
            var device = new MultifunctionalDevice("32124124");
            device.PowerOff();
